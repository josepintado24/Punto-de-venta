                ...
                <ul class="ul mt-5" style="font-size: 16px;">
                    ...
                    <li class="li">
                        ...
                        <ul class="ul-compras mb-2">
                            <li class="li-compras d-flex justify-content-end"><a href="<?php echo base_url() . '/compras/nuevo'; ?>">
                                    <div class="div-compras">
                                        <p class="p-compras">Nuevos</p>
                                    </div>
                                </a></li>
                            <li class="li-compras d-flex justify-content-end"><a href="<?php echo base_url() . '/compras'; ?>">
                                    <div class="div-compras">
                                        <p class="p-compras">Compras</p>
                                    </div>
                                </a></li>
                        </ul>
                    ...
                    <li class="li">
                        <a id="click" href="<?php echo base_url() . '/proveedores'; ?>" style="text-decoration: none;">
                            <div class="p-2 bd-highlight">
                                <div class="d-flex justify-content-start align-items-center ml-4 m-2 find-click">
                                    <svg class="mr-4" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg" d="M2.4 7.2C3.2825 7.2 4 6.4825 4 5.6C4 4.7175 3.2825 4 2.4 4C1.5175 4 0.8 4.7175 0.8 5.6C0.8 6.4825 1.5175 7.2 2.4 7.2ZM13.6 7.2C14.4825 7.2 15.2 6.4825 15.2 5.6C15.2 4.7175 14.4825 4 13.6 4C12.7175 4 12 4.7175 12 5.6C12 6.4825 12.7175 7.2 13.6 7.2ZM14.4 8H12.8C12.36 8 11.9625 8.1775 11.6725 8.465C12.68 9.0175 13.395 10.015 13.55 11.2H15.2C15.6425 11.2 16 10.8425 16 10.4V9.6C16 8.7175 15.2825 8 14.4 8ZM8 8C9.5475 8 10.8 6.7475 10.8 5.2C10.8 3.6525 9.5475 2.4 8 2.4C6.4525 2.4 5.2 3.6525 5.2 5.2C5.2 6.7475 6.4525 8 8 8ZM9.92 8.8H9.7125C9.1925 9.05 8.615 9.2 8 9.2C7.385 9.2 6.81 9.05 6.2875 8.8H6.08C4.49 8.8 3.2 10.09 3.2 11.68V12.4C3.2 13.0625 3.7375 13.6 4.4 13.6H11.6C12.2625 13.6 12.8 13.0625 12.8 12.4V11.68C12.8 10.09 11.51 8.8 9.92 8.8ZM4.3275 8.465C4.0375 8.1775 3.64 8 3.2 8H1.6C0.7175 8 0 8.7175 0 9.6V10.4C0 10.8425 0.3575 11.2 0.8 11.2H2.4475C2.605 10.015 3.32 9.0175 4.3275 8.465Z" fill="#9FA2B4" />
                    ...
                    <li class="li">
                        ...
                        <ul class="ul-prod mb-2">
                            <li class="li-prod d-flex justify-content-end"><a href="<?php echo base_url() . '/productos'; ?>">
                                    <div class="div-prod">
                    ...
                    <li class="li">
                        ...
                        <ul class="ul-reportes mb-2">
                            <li class="li-reportes d-flex justify-content-end"><a href="<?php echo base_url() . '/productos'; ?>">
                                    <div class="div-reportes">
                                        <p class="p-reportes">Productos</p>
                                    </div>
                                </a></li>
                            <li class="li-reportes d-flex justify-content-end"><a href="<?php echo base_url(); ?>/unidades">
                                    <div class="div-reportes">
                                        <p class="p-reportes">Unidades</p>
                                    </div>
                                </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="li">
                        <a class="m-config-list" id="click" href="#" style="text-decoration: none;">
                            <div class="p-2 bd-highlight">
                                <div class="d-flex justify-content-start align-items-center ml-4 m-2 find-click">
                                    ...
                                    <p class="p-hover" style="font-size: 15px;">Administración</p>
                                    <svg class="ml-auto" width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M-2.44664e-08 0.559726L0.413445 -5.06464e-07L11.6067 -1.71907e-08L12 0.539249L6.37311 6H5.54622L-2.44664e-08 0.559726Z" fill="#C5C5C5" />
                                    </svg>
                                </div>
                        ...
                        <ul class="ul-config mb-2">
                            <li class="li-config d-flex justify-content-end"><a href="<?php echo base_url() . '/usuarios'; ?>">
                                    <div class="div-config">
                                        <p class="p-config">Usuarios</p>
                                    </div>
                                </a>
                            </li>
                            <li class="li-config d-flex justify-content-end"><a href="<?php echo base_url() . '/configuracion'; ?>">
                                    <div class="div-config">
                                        <p class="p-config">Configuración</p>
                                    </div>
                                </a>
                            </li>
