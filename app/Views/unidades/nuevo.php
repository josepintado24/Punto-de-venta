<div id="layoutSidenav_content">
                <main>
                <a href="<?php echo base_url();?>/unidades" class="btn btn-info m-4">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input value="<?php echo set_value('nombre_corto');?>" class="form-control" id="nombre_corto" name="nombre_corto" type="text" required >
                                        </div>
                                    </div>    
                                </div>
