                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input value="<?php echo set_value('nombre');?>" class="form-control" id="nombre" name="nombre" typr="text" autofocus required>
                                        </div>
                                    </div>    
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <Select class="form-control" id="id_unidad" name="id_unidad" typr="text"  required>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input value="<?php echo set_value('precio_compra');?>" class="form-control" id="precio_compra" name="precio_compra" type="number" step="any" required>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input  value="<?php echo set_value('precio_venta');?>" class="form-control" id="precio_venta" name="precio_venta" type="number" step="any" required>
                                        </div>

                                        <div class="col-12 col-sm-6">
                                            <label for="">Stock minimo</label>
                                            <input  value="<?php echo set_value('stock_minimo');?>"  class="form-control" id="stock_minimo" name="stock_minimo" type="number"  required>
                                        </div>
                                    </div>    
                                </div>
