                        ...
                        <tbody>
                            ...
                            foreach ($datos as $dato) { ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format(($dato['envio_costo'] + $dato['otro_detalle_costo'] + $dato['total']) - $dato['descuento'], 2, '.', ','); ?> </td>
                                    <td><?php echo $dato['cajero']; ?> </td>
                                    <td class="text-center">
                                        <a href="<?php echo base_url() . '/ventas/muestraTicketPdf/' . $dato['id']; ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-list-alt"></i>
                                        </a>
                                        <a href="#" data-href="<?php echo base_url() . '/ventas/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Eliminar registro" class="btn btn-danger btn-sm">
